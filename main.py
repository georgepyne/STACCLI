...
def main() -> None:
    ...
    try:
        ...
        for a in assets:
            cog_urls = cog_urls + [
                i["assets"][a]["href"] for i in [ordered_features[2]]
            ]
        # cogs = [rasterio_open(i) for i in cog_urls]

        outvrt = (
            "/vsimem/stacked.vrt"  # /vsimem is special in-memory virtual "directory"
        )
        ...
        gdal.Translate("/Users/geo/Desktop/testWarp.png", outtif, options=options)
